...
Main.StandardColor = "#B22222";

Main.HighlightColor = "#FFD700";

Main.TextColor = "#00FFFF";
...
Main.CarouselSpacing = 15;

Main.CarouselVelocity = 0;

Main.CarouselInertiaDirection = "right";

Main.VelocityToPixelTranslation = 30;

Main.VelocityDegradation = 50;
...

{
	...
	Main.Context.font = "40px Times New Roman Blue";
	...
	Main.Context.fillStyle = Main.TextColor;
